...
async def get_user_chats(
    ...
    if page is not None and limit is not None:
        ...
        return await Chats.get_chats_list(skip=skip, limit=limit, db=db)
    else:
        return await Chats.get_chats_list(skip=0, limit=50, db=db)
...
async def get_shared_chat_by_id(
    ...
    # TODO: Renesas NO LIMIT WHEN ACCESS CHAT
